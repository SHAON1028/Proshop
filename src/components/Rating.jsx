...
const Rating = ({ rating, color, reviews }) => {
    return (
        <div className='rating'>
            <span>
                ...
                <i style={{ color: color }} className={rating >= 4 ? "fas fa-star" : rating >= 4.5 ? "fas fa-star-half-alt" : "far fa-star"}></i>
            </span>
            <span className='p-1'>{reviews && reviews}</span>
